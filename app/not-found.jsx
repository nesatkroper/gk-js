      ...
      <div className="w-full max-w-2xl mx-auto text-center space-y-8">
        ...
        <Card className="p-6 md:p-8 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm border-0 shadow-xl">
          <p className="text-lg md:text-xl text-slate-600 dark:text-slate-300 leading-relaxed">
            {t("Looks like you're lost! We couldn't find the page you were looking for. It might have been moved, deleted, or the link might be broken.")}
          </p>
        </Card>
        ...
        <div className="pt-8 text-xs text-slate-400 dark:text-slate-500">
          <p>
            {t("Fun fact: HTTP 404 errors were named after room 404 at CERN where the original web server was located! 🌐")}
          </p>
        </div>
      </div>
    </div>
