...
import { useTranslation } from "react-i18next" // Already here, great!
...
export function EnhancedHeader() {
  ...
  // Ensure lastSegment is translated if it needs to be displayed as a readable string
          ...
          <nav className="flex items-center space-x-1">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="relative h-8 w-8 rounded-full">
                  <Avatar className="h-8 w-8">
                    <AvatarImage src="/images/profile.webp" alt={t("User profile image")} /> {/* Translate alt text */}
                    <AvatarFallback className="bg-primary text-primary-foreground text-xs">
                      {!mounted
                        ? t('AD') // Server-side fallback, translate "AD"
                        : me?.Employee
              ...
              <DropdownMenuContent className="w-56" align="end" forceMount>
                ...
                <DropdownMenuItem
                  onClick={() => {
                    console.log("Logging out...") // This is a console log, doesn't need translation
                    logout()
